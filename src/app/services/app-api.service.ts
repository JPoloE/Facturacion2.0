...
export class AppApiService {
  ...
  ObtenerClientes(id: number, idest: string) {
    return this.getQuery(`ObtenerClientes?id=${id}&idest=${idest}`);
  }
  ...
  ObtenerObrasCliente(id_cliente: number) {
  ...
  ObtenerConsecutivoProspecto() {
    return this.getQuery(`ObtenerConsecutivoProspecto`);
  }
